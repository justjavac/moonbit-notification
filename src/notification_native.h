...
#ifdef _WIN32
int32_t desktop_notification_windows_show(
    int64_t window_handle, moonbit_bytes_t title, moonbit_bytes_t body,
    int32_t level);
#endif
...
#ifdef __APPLE__
int32_t desktop_notification_macos_is_supported(void);
int32_t desktop_notification_macos_show(
    int64_t window_handle, moonbit_bytes_t title, moonbit_bytes_t body,
    int32_t level);
#endif
...
int32_t desktop_notification_linux_is_supported(void);
int32_t desktop_notification_linux_show(
    int64_t window_handle, moonbit_bytes_t title, moonbit_bytes_t body,
    int32_t level);
#endif
